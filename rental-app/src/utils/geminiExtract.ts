...
export const extractPropertyDataFromImage = async (
  ...
  const lines = [
    ...
    "renewalFeeRate: 更新料の倍率(数値のみ。「新賃料の1ヶ月分」→1、「新賃料の2ヶ月分」→2。記載なければnull)",
    "renewalAdminFeeRate: 更新事務手数料の倍率(数値のみ。「0.5ヶ月分」→0.5。記載なければnull)",
    "guaranteeRenewalFee: 保証会社更新料(円、数値のみ。「10,000円/年」→10000。記載なければnull)",
    "insuranceRenewalFee: 火災保険の2年ごとの更新額(円、数値のみ。記載なければnull)",
    "supportRenewalFee: 24時間サポートの2年ごとの更新額(円、数値のみ。記載なければnull)",
    "",
